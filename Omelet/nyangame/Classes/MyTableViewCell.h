...
protected:
    ...
    CC_SYNTHESIZE_RETAIN(CCSprite*, m_imageMonsterSprite, ImageMonsterSprite);
...
public:
    ...
    // 生成メソッド
    virtual bool init();
    virtual bool initWithLabel(CCLabelTTF* textLabel, CCLabelTTF* detailLabel, CCSprite *imageSprite, CCSprite *imageMonsterSprite);
    static MyTableViewCell* create(CCLabelTTF* textLabel, CCLabelTTF* detailLabel, CCSprite *imageSprite, CCSprite *imageMonsterSprite);
    static MyTableViewCell* create(const char *text, const char *fontName, float fontSize,
                                   ...
                                   const char* imageMonsterPath=NULL);
    CREATE_FUNC(MyTableViewCell);
    
    static CCSize cellSize();
    // プロパティ
    void setImagePath(const char* path);
    void setImageMonsterPath(const char* path);
